        ...
        try:
            ...
            if user_input.lower() == 'reset':
                ...
                manager.conversations[user_id]["profile"] = {
                    ...
                    "gender": "female", "activity_level": None, "fitness_goal": None,
                    "current_week": 1, "dietary_restrictions": []
                }
            ...
            profile_summary = []
            if profile['weight_kg']: profile_summary.append(f"{profile['weight_kg']}kg")
            if profile['height_cm']: profile_summary.append(f"{profile['height_cm']}cm")
            if profile['age']: profile_summary.append(f"{profile['age']}y")

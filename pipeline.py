...
class FitnessChatbotPipeline:
    ...
    def process_message(self, user_message: str, user_id: str) -> Dict:
        ...
        try:
            ...
            print(f"[Pipeline] User state loaded: Week {user_state['week']}, Goal: {user_state['fitness_goal']}")
            
            # STEP 3: Check if this intent requires full pipeline
            if intent in ['weight_loss_plan', 'muscle_gain_plan', 'maintenance_plan', 
                         'diet_suggestion', 'food_plan', 'meal_plan']:
    ...
    def _format_response(self, intent: str, roadmap: Dict, meal_message: str, 
                        user_state: Dict) -> str:
        """
...
if __name__ == "__main__":
    ...
    try:
        ...
        result1 = pipeline.process_message(
            user_message="I want to lose weight in 3 months",
        ...
        result2 = pipeline.process_message(
            user_message="Give me this week's diet plan",
            user_id="test_user_001"
        )
